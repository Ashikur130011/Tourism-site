            ...
            {/* ------Top Tour----- */}
              <div className="row">
                <div className="col-md-12">
                  <h1 className=" mb-4">Top <span className="text-danger">Tour</span> Packages</h1>
              ...
              <div className="row my-5 pt-3">
                <h1 className=" pb-3"><span className="text-danger">Popular</span> Cities</h1>
...
<Carousel className="mb-5 slider mx-auto" style={{height:"400px"}}>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption>
      ...
      <p className="fw-bold">New York City is like no other city in the world, and one that must be experienced to be fully appreciated.</p>
    </Carousel.Caption>
  </Carousel.Item>
  <Carousel.Item>
    <img
    ...
    <Carousel.Caption>
      ...
      <p className="fw-bold">European countries have had time to perfect urban planning and get public transport under control. This makes getting around so easy! </p>
    </Carousel.Caption>
  </Carousel.Item>
</Carousel>
                </div>
